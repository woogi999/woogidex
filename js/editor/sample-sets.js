...
// ==================== stat calculation ====================
        ...
        // adapter for the shared battle-engine stat formula (dex.js), so the editor
                ...
                if (calcEl) {
                    ...
                    if (row) {
                        ...
                        if (track) {
                            ...
                            // don't write .value onto the slider mid-drag -- it resets
                            // browser drag tracking and the thumb stops following the mouse
                            if (slider && slider !== document.activeElement) slider.value = clampedEV;
...
function updateStatDisplay(setIndex, statKey, evVal, ivVal) {
            ...
            if (card) {
                ...
                if (row) {
                    ...
                    // same guard as updateSampleSetEV: don't stomp a mid-drag slider
                    if (slider && evVal !== null && slider !== document.activeElement) slider.value = ev;
                ...
                return `
                    <div class="sample-set-card" data-set-index="${i}">
                        ...
                        <div style="margin-top:8px;">
                            <div style="font-size:10px;color:var(--text-muted);font-weight:700;margin-bottom:4px;">Moves</div>
