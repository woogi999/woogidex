...
// (see ../teams.ts); only a snapshot entering one specific battle is sent.

import { api } from '../../core/app.ts';
import { nextBattleToAnnounce } from './protocol.ts';
...
export class BattleLobby {
    ...
    _busy: any;
    _announced: any;
    constructor({ onLobby, onChallenges, onBattleStart, onError }: { onLobby?: any; onChallenges?: any; onBattleStart?: any; onError?: any } = {}) {
