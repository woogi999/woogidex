...
import { playMoveFX, resolveMoveInfo, shapeFor, MOVE_FX_MS } from './move-anim.ts';
...
export class BattleScene {
    ...
    field3d: any;
    _introDone: any;
    constructor({ battle, mySide, formatLine, onPhaseChange, field }: { battle?: any; mySide?: any; formatLine?: any; onPhaseChange?: any; field?: any }) {
        this.battle = battle;
        this.mySide = mySide;
        ...
        return {
            ...
            sides: this.battle.sides.map(side => ({
                ...
                conditions: Object.fromEntries(
                    Object.entries<any>(side.conditions || {}).map(([k, v]) => [k, v.layers || 1])),
    ...
    _paintSide(sideIndex) {
        ...
        const shown = Object.entries<any>(vmon.boosts).filter(([, v]) => v);
    ...
    _shotsFor(shape, info, sideIndex, targetIndex, isSelf = false) {
        ...
        if (isSelf) return { attacker: push(sideIndex), target: null as any };
