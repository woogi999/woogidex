...
// consumes. Deliberately pure (no DOM/app.ts) so it's unit-testable in Node,
// and the engine only ever reads Fakemon data through here.

import { TYPE_EFFECTIVENESS } from '../../core/data.ts';
...
// duplicated from data.ts's NATURE_DATA, pre-converted to multipliers
const NATURE_MODS = {
...
export class BattleDex {
    ...
    customItems: any;
    _moveCache: any;
    constructor({ sdMoves = {}, customMoves = [], customAbilities = [], customItems = [], sdItems = {}, sdAbilities = {} }: { sdMoves?: any; customMoves?: any; customAbilities?: any; customItems?: any; sdItems?: any; sdAbilities?: any } = {}) {
    ...
    // built in the block editor, else null. ability-runtime.ts compiles program into handlers.
    ...
    getItem(nameOrId) {
        ...
        return Object.freeze({
            ...
            custom: false, program: null as any, rawCode: ''
        });
    }
...
function normalizeCustomMove(m, fallbackId) {
    return Object.freeze({
        ...
        // hand-written hooks; only run when trusted - see sd-hooks.ts compileRawHooks
        rawCode: m.rawCode || ''
    });
}
...
export const SD_MOVE_FIELDS = [
    ...
    'multihit',
    // kept as plain data so moves still behave correctly if the simulator table (sd-moves.ts) can't be reached
...
function normalizeSdMove(sd, id, originalName) {
    if (!sd) {
        ...
        return Object.freeze({
            ...
            desc: '', custom: false, target: 'self', critRatio: 0, drain: null as any, recoil: null as any,
            heal: null as any, status: null as any, volatileStatus: null as any, boosts: null as any,
            secondaries: Object.freeze([]), multihit: null as any, weather: null as any, terrain: null as any,
            sideCondition: null as any, selfSwitch: null as any, self: null as any, willCrit: false, damage: null as any,
            forceSwitch: false, thawsTarget: false, sleepUsable: false, breaksProtect: false,
            ohko: false, ignoreImmunity: false, overrideOffensiveStat: null as any,
            overrideDefensiveStat: null as any, program: null as any, rawCode: '', unknown: true
        });
    }
    return Object.freeze({
        id,
...
function sdAbilityEntry(name, sd) {
    return Object.freeze({
        ...
        desc: sd?.desc || '', custom: false, program: null as any, rawCode: ''
    });
}
