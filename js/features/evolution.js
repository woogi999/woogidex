...
function drawEvolutionEdges() {
    ...
    // read actual handle geometry since method cards' height differs and can change at breakpoints.
    ...
    g.edges.forEach(edge => {
        ...
        // wider transparent hitbox keeps the visual wire thin while staying easy to hit on touch.
...
function findNearestCompatibleHandle(e, sourceNodeId, sourceSide) {
    ...
    board.querySelectorAll('.evo-handle').forEach(handle => {
        ...
        // connection must end up right -> left; either handle can start the drag.
