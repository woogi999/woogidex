 ...
 */
export function prepareCommunityFeed(rows: any[], { search = '', sortBy = 'published', sortOrder = 'desc' }: { search?: any; sortBy?: any; sortOrder?: any } = {}) {
 ...
 * back to a raw count.
 *
 * @returns null for an ordinary single-Fakemon post
 */
export function evoBadgeLabel(row): string|null {
