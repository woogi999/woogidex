// Renders the Markdown in public/legal/*.md into HTML for legal.ts. Split out
 ...
 * @param text heading text, already stripped of markdown
 */
...
function inline(text: string): string {
    return text
        ...
        // destination routed by legal.ts's click handler (a real navigation
...
export function renderMarkdown(markdown: string): string {
    ...
    const out: any[] = [];
    let list: any = null;   // 'ul' | 'ol' while one is open
