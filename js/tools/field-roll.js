...
// generic dice-button popover shared by the "roll" fields below (same
// fixed-position, zoom-corrected, scroll-closing popover as name-roll.js,
// kept as a separate copy so each field supplies its own generator/label/apply)
...
// see name-roll.js: CSS `zoom` rescales position:fixed offsets too
...
function renderFieldRollPopover(point, generate, formatLabel, onApply) {
    ...
    // see name-roll.js's renderPopover for why point/offset units need converting
